                        ...
                        <div class="contact_form_container">
                            ...
                            <form action="{{ route('register')}}" id="contact_form" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" aria-describedby="emailHelp" placeholder="Enter Your Email" required="">
                                </div>
                                ...
                                <div class="contact_form_button">
                                    <button type="submit" class="btn btn-info">Sigh Up</button>
                                </div>
                            </form>
