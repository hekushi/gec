                        ...
                        <div class="contact_form_container">
                            ...
                            <form action="{{ route('payment.process')}}" id="contact_form" method="post">
                                ...
                                <div class="form-group">
                                    <ul class="logos_list">
                                        <li>
                                            <input type="radio" name="payment" value="stripe"><img src="{{ asset('frontend/images/mastercard.png')}}" style="height: 80px; width: 100px;">
                                        </li>
                                       
                                        <li>
                                            <input type="radio" name="payment" value="paypal"><img src="{{ asset('frontend/images/paypal.png')}}" style="height: 80px; width: 100px;">
                                        </li>

                                        <li>
                                            <input type="radio" name="payment" value="oncash"><img src="{{ asset('frontend/images/ecbzns013_002.jpg')}}" style="height: 80px; width: 100px;">
                                        </li>
